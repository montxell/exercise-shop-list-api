...
function createProductsList(product) {
  ...
  let buttonEdit = $("<button>").addClass("button-edit").attr("data-productid", id).text("Edit");
  let buttonDelete = $("<button>").addClass("button-delete").attr("data-productid", id).text("Delete");
